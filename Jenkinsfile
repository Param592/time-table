node('master') {
    ...
    stage('Checkout/Build/Test') {
        ...
        // Build and Test
        sh 'xcodebuild -scheme "TimeTable" -configuration "Debug" build test -destination "platform=iOS Simulator,name=iPhone 6,OS=11.4" -enableCodeCoverage YES | /usr/local/bin/xcpretty -r junit'
